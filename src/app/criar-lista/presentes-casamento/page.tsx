...
export default function PresentesCasamento() {
  const [presentes, setPresentes] = useState([
    { id: 1, nome: 'Aparelho de jantar', preco: 345.00, imagem: '/images/aparelho.png' },
    { id: 2, nome: 'Batedeira', preco: 150.00, imagem: '/images/batedeira.png' },
    { id: 3, nome: 'Bomboniere em cristal', preco: 98.50, imagem: '/images/bomboniere.png' },
    { id: 4, nome: 'Conjunto de facas', preco: 120.00, imagem: '/images/facas.png' },
    { id: 5, nome: 'Porta temperos', preco: 89.90, imagem: '/images/porta-temperos.png' },
  ]);
